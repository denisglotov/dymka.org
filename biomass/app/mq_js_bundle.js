...
(canvas.focus(),
  (canvas.requestPointerLock =
    canvas.requestPointerLock || canvas.mozRequestPointerLock || function () {}),
...
function UTF8ToString(e, t) {
  ...
  for (var n, a, r, c, s = 0, l = s + t, o = ''; !(s >= l);) {
    ...
    ((r = i[s++] & 63),
      ...
      n < 65536
        ? (o += String.fromCharCode(n))
        : ((c = n - 65536), (o += String.fromCharCode(55296 | (c >> 10), 56320 | (c & 1023)))));
  }
  return o;
}
function stringToUTF8(e, t, n, s) {
  for (var o, r, c = n, i = n + s, a = 0; a < e.length; ++a)
    if (
      ...
      o >= 55296 &&
        o <= 57343 &&
        ((r = e.charCodeAt(++a)), (o = (65536 + ((o & 1023) << 10)) | (r & 1023))),
      o <= 127)
    ) {
      if (n >= i) break;
      t[n++] = o;
...
((FS = { loaded_files: [], unique_id: 0 }),
  (GL = {
    ...
    validateGLObjectID: function (e, t, n, s) {
      t != 0 &&
        (e[t] === null
          ? console.error(n + ' called with an already deleted ' + s + ' ID ' + t + '!')
          : e[t] || console.error(n + ' called with an invalid ' + s + ' ID ' + t + '!'));
    },
    getSource: function (e, t, n, s) {
      for (var a, i = '', o = 0; o < t; ++o)
        ((a = s == 0 ? (0)[0] : getArray(s + o * 4, Uint32Array, 1)[0]),
...
function _webglGet(e, t, n) {
  if (!t) {
    (console.error(
      'GL_INVALID_VALUE in glGet' + n + 'v(name=' + e + ': Function called with null out pointer!'
    ),
      GL.recordError(1281));
    return;
  }
  ...
  switch (e) {
    ...
    case 36344:
      n != 'EM_FUNC_SIG_PARAM_I' &&
        ...
        (GL.recordError(1280),
        err(
          'GL_INVALID_ENUM in glGet' + n + 'v(GL_SHADER_BINARY_FORMATS): Invalid parameter type!'
        ));
      return;
    case 34814:
    case 36345:
  ...
  if (o === (0)[0])
    switch (((s = gl.getParameter(e)), typeof s)) {
      ...
      case 'string':
        (GL.recordError(1280),
          console.error(
            'GL_INVALID_ENUM in glGet' + n + 'v(' + e + ') on a name which returns a string!'
          ));
        return;
      case 'object':
        if (s === null)
          switch (e) {
            ...
            default: {
              (GL.recordError(1280),
                console.error(
                  'GL_INVALID_ENUM in glGet' + n + 'v(' + e + ') and it returns null!'
                ));
              return;
            }
          }
...
function resize(e, t) {
  ...
  (e.width != n || e.height != s) &&
    ((e.width = n), (e.height = s), t != null && t(Math.floor(n), Math.floor(s)));
}
function animation() {
  (wasm_exports.frame(),
...
`),
          ...
          o.indexOf('attribute') != -1
            ? ((o = o.replace(/attribute/g, 'in')), (o = o.replace(/varying/g, 'out')))
...
` + i
      ...
      glGetShaderiv: function (e, t, n) {
        if (
          (assert(n), GL.validateGLObjectID(GL.shaders, e, 'glGetShaderiv', 'shader'), t == 35716)
        ) {
          var s,
            i,
      ...
      glDeleteFramebuffers: function (e, t) {
        for (var n, o, s = 0; s < e; s++) {
          if (((o = getArray(t + s * 4, Uint32Array, 1)[0]), (n = GL.framebuffers[o]), !n))
            continue;
      ...
      glDeleteRenderbuffers: function (e, t) {
        for (var n, o, s = 0; s < e; s++) {
          if (((o = getArray(t + s * 4, Uint32Array, 1)[0]), (n = GL.renderbuffers[o]), !n))
            continue;
          (gl.deleteRenderbuffer(n), (n.name = 0), (GL.renderbuffers[o] = null));
        }
      },
      ...
      glDeleteQueries: function (e) {
        for (var n, o, s = 0; s < e; s++) {
          if (((o = getArray(textures + s * 4, Uint32Array, 1)[0]), (n = GL.timerQueries[o]), !n))
            continue;
      ...
      glRenderbufferStorageMultisample: function (e, t, n, s, o) {
        gl.renderbufferStorageMultisample(e, t, n, s, o);
      },
      glFramebufferRenderbuffer: function (e, t, n, s) {
        (GL.validateGLObjectID(GL.renderbuffers, s, 'glFramebufferRenderbuffer', 'renderbuffer'),
          gl.framebufferRenderbuffer(e, t, n, GL.renderbuffers[s]));
      },
      ...
      run_animation_loop: function (e) {
        ((canvas.onmousemove = function (e) {
          ...
          (wasm_exports.mouse_move(Math.floor(n), Math.floor(s)),
            (e.movementX != 0 || e.movementY != 0) &&
              wasm_exports.raw_mouse_move(Math.floor(e.movementX), Math.floor(e.movementY)));
        }),
          ...
          window.addEventListener('copy', function () {
            clipboard != null &&
              (event.clipboardData.setData('text/plain', clipboard), event.preventDefault());
          }),
        ...
        var t = function () {
          let e = document.hasFocus() && document.visibilityState == 'visible';
      ...
      fs_take_buffer: function (e, t, n) {
        ...
        for (i = new Uint8Array(wasm_memory.buffer, t, n), s = 0; s < o.length; s++) i[s] = o[s];
...
function init_plugins(e) {
  ...
  for (var n, s, t = 0; t < e.length; t++)
    (e[t].on_init != (0)[0] && e[t].on_init != null && e[t].on_init(),
      e[t].name == (0)[0] || e[t].name == null || e[t].version == (0)[0] || e[t].version == null
...
((function () {
    ...
    function o(n) {
      ((n.env.js_create_string = function (e, n) {
        ...
        (n.env.js_unwrap_to_buf = function (t, n, s) {
          for (
            var i = e[t], a = i.length, r = new Uint8Array(wasm_memory.buffer, n, s), o = 0;
            o < a;
            o++
          )
            r[o] = i[o];
  ...
  (function () {
    function i() {}
    var register_plugin = function (e) {
      ((e.env.ws_connect = r),
        (e.env.ws_is_connected = a),
        (e.env.ws_send = c),
        (e.env.ws_try_recv = l),
        (e.env.http_make_request = u),
        (e.env.http_try_recv = d));
    };
    miniquad_add_plugin({ register_plugin, on_init: i, version: 1, name: 'quad_net' });
    var e,
      t,
      s,
      o = 0,
    ...
    function r(t) {
      ((e = new WebSocket(consume_js_object(t))),
    ...
    function c(t) {
      var n = consume_js_object(t);
      n.buffer != (0)[0] ? e.send(n.buffer) : e.send(n);
    }
    function l() {
